  ...
  return (
    <>
      ...
      <HeroSection
        ...
        mainTitle={
          <>
            FREE <br className="max-custom-lg:!block" /> Consultation
          </>
        }
        subtitle="with 3D simulation"
        location="in Geneva, Montreux and Gstaad"
        btnText="ONLINE BOOKING"
        video="/assets/images/blepharoplasty-booking-video.mp4"
      />
      <FirstSection
        ...
        paragraphOne="— Examine the excess tissues on your upper and lower lids"
