        ...
        <div className="row cs_gap_y_40 ">
          ...
          <div className="col-lg-7 cs_pl_30">
            ...
            <p className="cs_about_text cs_type_2">
              — Examine your skin with VISIA scanner
            </p>
            <p className="cs_about_text cs_type_2 pl-0">
              — Visualize possible plastic surgery results in 3D
            </p>
            <p className="cs_about_text cs_type_2 pl-0">
              — Craft necessary injections and treatments plan
            </p>
            <p className="cs_about_text cs_type_2">
              At the end of the consultation you will know what is the best
