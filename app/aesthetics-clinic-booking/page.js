...
export default function Home() {
  return (
    <>
      <Header />
      <HeroSection
        title="First consultation at"
        mainTitle={
          <>
            AESTHETICS <br className="max-custom-lg:!block" /> CLINICS
          </>
        }
        subtitle=""
        location="in Geneva, Montreux and Gstaad"
        btnText="ONLINE BOOKING"
        video="/assets/images/aesthetic-clinic-booking-video.mp4"
      />
      <FirstSection
        ...
        paragraphOne="— Examine your skin with VISIA scanner"
        paragraphTwo="— Visualize possible results in 3D"
        paragraphThree="— Craft necessary injections and treatments plan"
        paragraphFour=" At the end of the consultation you will know what is the best
              approach for your aesthetics needs"
        btnText="ONLINE BOOKING"
        goToFormDescription={
          <>
