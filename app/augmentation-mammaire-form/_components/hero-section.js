        ...
        <div style={{ position: "relative" }} className="cs_hero_in">
          <div className="cs_hero_text">
            ...
            <h1 className="cs_hero_title cs_fs_60 cs_semibold">
              AUGMENTATION <br /> MAMMAIRE
            </h1>
            <p className="cs_hero_subtitle">avec simulation 3D</p>
            <p className="cs_hero_subtitle">à Genève, Gstaad et Montreux!</p>
          ...
          <div className="cs_hero_img w-full max-w-[830px]">
            <video
              id="heroVideo"
              ref={videoRef}
              src="/assets/images/augmentation-mammaire-form-video.mp4"
              alt="Hero Image"
              controls=""
            />
            <button
