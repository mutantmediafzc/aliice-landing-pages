  ...
  return (
    <>
      ...
      <HeroSection
        ...
        mainTitle={
          <>
            AUGMENTATION <br className="max-custom-lg:!block" /> MAMMAIRE
          </>
        }
        subtitle="avec simulation 3D"
        location="à Genève, Gstaad et Montreux!"
        btnText="Réservation"
        video="/assets/images/augmentation-mammaire-form-video.mp4"
      />
      <FirstSection
        ...
        paragraphOne="— Trouvez le meilleur taille pour vous"
