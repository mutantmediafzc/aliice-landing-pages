      ...
      <div className="container">
        <div style={{ position: "relative" }} className="cs_hero_in">
          <div className="cs_hero_text">
            ...
            <h1 className="cs_hero_title cs_fs_60 cs_semibold uppercase">
            Hyaluronic <br /> Acid Fillers
            </h1>
            <p className="cs_hero_subtitle"></p>
          ...
          <div className="cs_hero_img">
            <video
              id="heroVideo"
              ref={videoRef}
              src="/assets/images/fillers-reservation-video.mp4"
              alt="Hero Image"
              controls=""
            />
            <button
